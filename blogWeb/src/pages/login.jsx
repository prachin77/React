...
const Login = () => {
    ...
    const register = async () => {
        ...
        try {
            ...
            setRegMode(false); // If applicable, redirect or prompt for login
            ...
            if (error.code === "auth/user-not-found") {
                ...
                // Optional: Additional actions like sending a welcome email, logging user details, etc.
            } 
            // else {
    ...
    return (
        ...
        <div class="container mx-auto p-8 bg-gray-100 rounded-lg shadow-md max-w-md">
            <h3 class="text-3xl font-bold text-center mb-6 text-black">Authentication</h3>
